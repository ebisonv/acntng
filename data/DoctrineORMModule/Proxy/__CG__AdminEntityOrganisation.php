 ...
 */
class Organisation extends \Admin\Entity\Organisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'name', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'description', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'createDate', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'updateDate', '' . "\0" . 'Admin\\Entity\\Organisation' . "\0" . 'status'];
        }
